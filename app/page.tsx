            ...
            <div className="bg-card border rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="border rounded-lg p-4 bg-secondary/20">
                  ...
                  <Button onClick={() => document.querySelector('[data-value="engineers"]')?.click?.()}>
                    Go to Engineers
                  </Button>
                </div>
                ...
                <div className="border rounded-lg p-4 bg-secondary/20">
                  ...
                  <Button onClick={() => document.querySelector('[data-value="equipment"]')?.click?.()}>
                    Go to Equipment
                  </Button>
                </div>
                ...
                <div className="border rounded-lg p-4 bg-secondary/20">
                  ...
                  <Button onClick={() => document.querySelector('[data-value="withdrawals"]')?.click?.()}>
                    Go to Withdrawals
                  </Button>
                </div>
                ...
                <div className="border rounded-lg p-4 bg-secondary/20">
                  ...
                  <Button onClick={() => document.querySelector('[data-value="reports"]')?.click?.()}>
                    Go to Reports
                  </Button>
                </div>
              </div>
