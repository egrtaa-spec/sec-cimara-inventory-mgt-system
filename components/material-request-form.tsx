...
export function MaterialRequestForm({ 
  ...
  const addItem = () => {
    ...
    setItems([...items, { id: Date.now().toString(), name: newItemName, quantity: newItemQty }]);
    setNewItemName("");
    newItemQty;
  };
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-md border space-y-6">
      ...
      <div className="flex gap-4 items-end">
        ...
        <Button onClick={addItem} type="button" variant="outline"><Plus className="w-4 h-4" /></Button>
      </div>
