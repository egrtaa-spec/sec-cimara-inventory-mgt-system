...
export function LoginModal({ isOpen, onOpenChange }: LoginModalProps) {
  ...
  try {
    ...
    if (!contentType || !contentType.includes("application/json")) {
      console.error("The server returned HTML instead of JSON. Check your proxy.ts or file paths.");
 ...
 if (data.success) {
  ...
  // This ensures the Proxy sees the new cookie and lets you into the dashboard.
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleLogin} className="space-y-4 mt-4">
          ...
          <p className="text-xs text-gray-600 text-center">
            Demo credentials: tahgizete / CimaraAdmin@123
          </p>
        </form>
      </DialogContent>
    </Dialog>
